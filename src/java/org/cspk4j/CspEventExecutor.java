...
public interface CspEventExecutor {

	void execute(CspProcess process, String event);
	
	String resolve(ProcessInternalChoice internalChoice);

	void timedOut(ProcessTimeout timeout);
