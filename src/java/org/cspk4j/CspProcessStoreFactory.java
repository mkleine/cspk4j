...
public abstract class CspProcessStoreFactory {
	
	public final CspProcessStore createProcessStore() {
		CspProcessStore result = new CspProcessStore();
		registerProcesses(result);
		return result;
	}
	
	public abstract void registerProcesses(CspProcessStore result);
}
